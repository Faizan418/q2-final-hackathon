        ...
        <div className={styles.upper_portion}>
          <div className={styles.upper_portion_div_one}>
            <span className={styles.name_and_icon}>
              <IoMailOutline className="text-lg" /> muhammadf4060@gmail.com
            </span>
            <span className={styles.name_and_icon}>
        ...
        <div className={styles.lower_portion}>
          ...
          >
            <ul className={styles.ul_div}>
              ...
              <Link href="/products"><li className={styles.li}>Products</li></Link>
              <Link href="/blog"><li className={styles.li}>Blog</li></Link>
              <Link href="/shop"><li className={styles.li}>Shop</li></Link>
