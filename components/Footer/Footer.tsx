    ...
    <div className={styles.containar}>
      ...
      <div className={styles.box}>
        <div className={styles.card}>
          ...
          <p className={styles.Get}>17 Princess Road, London Greader london <br /> NW-1 8JR, UK</p>
        </div>
        <div className={styles.card}>
          <h3 className={styles.headings_center}>Catagories</h3>
          <p className={styles.peras}><Link className={styles.Links} href={''}>Leptops & Computers</Link></p>
          <p className={styles.peras}><Link className={styles.Links} href={''}>Cameras & Photography</Link></p>
          <p className={styles.peras}><Link className={styles.Links} href={''}>Smart Phones & Tables</Link></p>
          <p className={styles.peras}><Link className={styles.Links} href={''}>Video Games & Consoles</Link></p>
          <p className={styles.peras}><Link className={styles.Links} href={''}>Waterproof Headphone</Link></p>
        </div>
        <div className={styles.card}>
          ...
          <p className={styles.peras}><Link className={styles.Links} href={''}>Discound</Link>  </p>
          <p className={styles.peras}><Link className={styles.Links} href={''}>Return</Link>  </p>
          <p className={styles.peras}><Link className={styles.Links} href={''}>Orders History</Link>  </p>
          <p className={styles.peras}><Link className={styles.Links} href={''}>Other Tracking</Link>  </p>

        </div>
        <div className={styles.card}>
          <h3 className={styles.headings_center}>Pages</h3>
          <p className={styles.peras}><Link className={styles.Links} href={""}>Blog</Link></p>
          <p className={styles.peras}><Link className={styles.Links} href={""}>Browse the Shop</Link></p>
          <p className={styles.peras}><Link className={styles.Links} href={""}>Catagory</Link></p>
          <p className={styles.peras}><Link className={styles.Links} href={""}>Pre-Build Pages</Link></p>
          <p className={styles.peras}><Link className={styles.Links} href={""}>Visual Composer Eiements</Link></p>
          <p className={styles.peras}><Link className={styles.Links} href={""}>E-Commerce Pages</Link></p>
        </div>
        {/* <div className={styles.card}>
